...
const Navbar = () => {
    ...
    return (
        <nav className='flex items-center justify-between py-4 px-10 fixed top-0 w-full max-w-384 bg-black/70 backdrop-blur-3xl text-white z-1000'>
            <div className="logo font-bold text-2xl">
                <h2>VideoAlchemist</h2>
            </div>

            <ul className='flex items-center gap-10 bg-(--color-primary-light)/10 backdrop-blur-3xl rounded-full py-3 px-7'>
