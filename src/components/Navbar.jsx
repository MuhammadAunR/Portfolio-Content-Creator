        ...
        <>
            <nav className='flex items-center justify-between py-4 px-5 md:px-10 fixed top-0 w-full max-w-384 text-white z-1000'>
                ...
                <ul className='flex items-center gap-10 border border-white bg-black/20 backdrop-blur-3xl rounded-full py-3 px-7 max-lg:hidden'>
                    ...
                    <a href='#about' onClick={(e) => handleScroll(e, "about")} className='text-lg hover:text-(--color-primary-light) transition-colors ease-linear'>
                        <li>About</li>
                    </a>
                    <a href='#portfolio' onClick={(e) => handleScroll(e, "portfolio")} className='text-lg hover:text-(--color-primary-light) transition-colors ease-linear'>
                        <li>Portfolio</li>
                    </a>
                    <a href='#contact' onClick={(e) => handleScroll(e, "contact")} className='text-lg hover:text-(--color-primary-light) transition-colors ease-linear'>
                        <li>Contact</li>
                    </a>
                </ul>
