...
const Drawer = () => {
    ...
    return (
        <>
            <section className={`bg-black/60 backdrop-blur-md min-h-70 w-full absolute z-5000 transition-transform ease-linear duration-300 ${openDrawer ? 'translate-y-0' : '-translate-y-full'}`}>
